...
public class AlbumController {
    ...
    private static String UPLOAD_LOCATION = "E:/photoApp/src/main/webapp/images/";
    ...
    public ModelAndView saveAlbum(HttpServletRequest request, @Valid @ModelAttribute("albumAvatarUpload") AlbumAvatarUpload albumAvatarUpload, @ModelAttribute("user") User user, BindingResult bindingResult) {
        ...
        if (albumDB != null){
            ...
            String pathServer = request.getServletContext().getRealPath("/images/") + file.getOriginalFilename();
            try {
                FileCopyUtils.copy(file.getBytes(), new File(path));
                FileCopyUtils.copy(file.getBytes(), new File(pathServer));
            } catch (IOException e) {
                e.printStackTrace();
            }
